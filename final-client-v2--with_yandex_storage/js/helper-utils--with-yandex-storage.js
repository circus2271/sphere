...
window['serverlessFunctionUrl'] = 'https://functions.yandexcloud.net/d4e25qdkqbjs5u7uj7tp?integration=raw'
window['objectStorageUrl'] = 'https://sphere-test-bucket.website.yandexcloud.net'
window['musicLibraryUrl'] = 'https://sphere-test-bucket.website.yandexcloud.net/test-foldre'
...
function sendLikeDislikeToServer() {
  ...
  var jqxhr = $.ajax({
    url: window['serverlessFunctionUrl'],
    method: "POST",
